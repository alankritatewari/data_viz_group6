...
```{r load datasets, warning=FALSE, message=FALSE, eval = FALSE}
# URL of the zip file
zip_url <- "https://github.com/alankritatewari/data_viz_group6/raw/main/data.zip"

# Filepath where you want to save the downloaded zip file (current directory)
zip_filepath <- file.path(getwd(), "data.zip")

# Download the zip file
download.file(zip_url, destfile = zip_filepath, mode = "wb")

# Unzip the contents into the current directory
unzip(zip_filepath, exdir = getwd())
...
```{r inspect data, warning =FALSE, message = FALSE, eval = FALSE}
